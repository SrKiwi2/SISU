...
public class HistorialLinameController {
    ...
    public String saveHistorial(@Validated HistorialLiname historialLiname, RedirectAttributes flash, HttpServletRequest request,
    @RequestParam(name = "historialLiname", required = false) Long idLiname
    ){
